...
var player_colour = Constants.COLOUR.YELLOW
...
var leadersDesc = [
	...
	"[u][color=#53f2cd]Clarissa[/color][/u]\nUnits heal 3 life when starting their turn on a property (at no additional cost).\n25% discount on the heal command.\n[u][color=#53f2cd]Power[/color][/u]\n[color=#53f2cd]Hyper Heal[/color] - All friendly units gain 2 hitpoints. Sally's units heal 3 hitpoints",
	"[u][color=#46324c]Redline[/color][/u]\n[u][color=#46324c]Power[/color][/u]\n[color=#46324c]Homestrech[/color] - Units gain +1 movement.\n\nTime is money!",
